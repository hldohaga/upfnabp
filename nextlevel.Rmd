...
This study looked at this association in the data set of the National dietary and nutrition survey (@universityofcambridge2022 ).The study gives data from 2008 to 2019.
...
```{r tbl-search-terms, message=FALSE, warning=FALSE, include=FALSE}
...
#flextable(search1)
png("/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/test.png")
save_as_image(width(autofit(flextable(search1)), width=5), "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/temp.png")
```
...
imd <- data.table(ndns_1_11[,c('EIMD_2015_quintile','WIMD_2014_quintile','SIMD_2016_quintile','NIMD_2017_quintile')])
#imd
#df1$IMD <- rowSums(imd , na.rm=TRUE)
#ndns_1_11$IMD <- NA
#case_when(is.na(ndns_1_11$IMD)~ (ndns_1_11$IMD <-ndns_1_11$EIMD_2015_quintile), is.na(ndns_1_11$IMD)~ (ndns_1_11$IMD <-ndns_1_11$WIMD_2014_quintile), is.na(ndns_1_11$IMD)~ (ndns_1_11$IMD <-ndns_1_11$SIMD_2016_quintile),is.na(ndns_1_11$IMD)~ (ndns_1_11$IMD <-ndns_1_11$NIMD_2017_quintile))))
...
ndns_1_11[,SIMD_2016_quintile := factor(SIMD_2016_quintile, levels = 1:5)]
ndns_1_11[,WIMD_2014_quintile := factor(WIMD_2014_quintile, levels = 1:5)]
ndns_1_11[,NIMD_2017_quintile := factor(NIMD_2017_quintile, levels = 1:5)]
...
#save_as_image(width(tblkeydata, width=5), "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/tblkeydata.png")
...
imdchi <- svychisq(~EIMD_2010_quintile+SurveyYear , ndns_1_11dd)
...
save_as_image(width(keydatwA, width=5), "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/keydatwA.png")
...
save_as_image(width(keydatwp, width=5), "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/keydatwp.png")
...
lm1AS <- svyglm(hyp ~  Sex +BMI +agegad3+educfinh + EIMD_2010_quintile ,family = binomial(link = "logit"), ndns_1_11dd , na.action = na.exclude)

theme_gtsummary_mean_sd()

#sodium only
lmna <- svyglm( hyp ~ hiNa  +Sex +agegad3 + BMI+educfinh+  EIMD_2010_quintile ,family = binomial(link = "logit"), ndns_1_11dd,na.action = na.exclude)

lmnaE <- svyglm(hyp ~ hiNa +Sex +agegad3+UPF3 + BMI +educfinh+ EIMD_2010_quintile ,family = binomial(link = "logit"), ndns_1_11dd,na.action = na.exclude)

lmME <- svyglm( hyp~ UPF3 +agegad3+Sex + BMI +educfinh + EIMD_2010_quintile ,family = binomial(link = "logit"), ndns_1_11dd,na.action =na.exclude)
...
save_as_image(multivariables, width=5, "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/multivariables.png")
...
flextable(AICt)
 ...
 png("/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/multivariables.png")
save_as_image(flextable(AICt), width=5, "/media/david/Elements1/contents/DOHmed/MPH/MPHModules/dissertation/alternativequant/upfnabp/data/AICt.png")
