...
```{r tbl-search-terms,warning=FALSE,include=TRUE}
...
#keydatw <-tbl_svysummary(ndns_1_11d,SurveyYear , include = c(Na,UPF,BP))
...
The difference between the two values as a proportion of the larger is `r sense2` %.
