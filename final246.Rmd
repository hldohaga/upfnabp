...
table1 <- data.table("Abbreviation "=c("AIC","BMI","BP","CHAMPs","CI","CVD","HR","IMD","Na","NCD","NDNS","NOVA","OR","UPF" ),"Term"=c("Akaike Information Criterion","Body Mass Index","Blood Pressure","Cheshire and Merseyside public health  collaborative","Confidence intervals 95% level","Cardiovascular Disease", "Hazard ratio","Index of Multiple Deprivation","Sodium intake in mg",  "Non communicable Disease","National Dietary and Nutrition Survey","NOVA is a classification system, it is not an acronym","Odds Ratio","Ultra Processed Foods"))
...
A better understanding of the mechanisms of UPF, such as the interaction with sodium, might help understand one way that Marmot's categories of influence work.
...
That there are constructivist aspects to this subject admits that the observer is closer to the model.
Hence, my positionality is of interest.
