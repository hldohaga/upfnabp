...
@tbl-Key-Variables-by-place shows that in comparison to the North West only London has a statistically significant negative gradient in salt intake.
The UPF intake is higher in Northern Ireland and the West Midlands, and lower in London.
The BP is lower in London only.
