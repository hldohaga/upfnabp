...
The study showed that there is a correlation between UPF intake and BP, and that this relationship remained over time while UPF intake has risen. It also showed that sodium intake is correlated with BP but this relationship changed as intake lowered over time.

The importance of this is that BP is a clinical outcome, and a proxy measure for CVD. The study shows that increasing UPF intakes increases the population risk of BP and CVD. It also shows that reduction of the sodium content is not effective at reducing the overall risk as reducing the proportion of UPF consumed.

Policy should aim to reduce intake of UPF and increase intake of unprocessed foods.


\newpage

#  Introduction
There is an association between blood pressure (BP) and intake of Ultra-processed Foods (UPF) and Salt intake. This association is identifiable in the data set of the National dietary and nutrition survey (NDNS). 

The relationship has changed between 2008 and 2019. There have been changes in the intake of UPF, of salt and BP. 
...
There will then be a critical review of the literature, before a synthesis of how it relates to the research question.
...
```{r echo=FALSE , caption = "Key variable against Survey Year"}
...
```{r echo=FALSE, message=FALSE, warning=FALSE, caption = "Categorical variables against Survey Year"}
