...
svyplot(omsysval~Epcnt_4, ndns_1_11e)
...
lm1g <- svyglm(omsysval ~ pcnt_4,ndns_1_11e)
...
#linear regression models
#sodium only
lm1AS <- svyglm(omsysval ~ Age + Sex +bmival , ndns_1_11e)
...
```{r echo=FALSE}
lmM <- svyglm(omsysval ~ Age +Sex +Sodiummg + sqrt(pcnt_4)+ wtval+TotalEMJ +ethgrp2 + VitaminDµg + educfinh+ EIMD_2010_quintile , ndns_1_11e,na.action = na.exclude)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
lmM2 <- svyglm(omsysval ~ Age +Sex +Sodiummg + EnergykJ_4+ bmival +ethgrp2 + VitaminDµg +educfinh+ EIMD_2010_quintile , ndns_1_11e,na.action = na.exclude)
...
```{r echo=FALSE, warning=FALSE}
lmMna <- svyglm(omsysval ~ Age +Sex +Sodiummg + sqrt(pcnt_4)+bmival , ndns_1_11e,na.action =na.exclude)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
lmMnaE <- svyglm(omsysval ~ Age +Sex +Sodiummg + EnergykJ_4 , ndns_1_11e,na.action =na.exclude)
...
```{r echo=FALSE}
lmMg <- svyglm(omsysval ~ Age +Sex + sqrt(pcnt_4) , ndns_1_11e)
...
```{r echo=FALSE}
lm4b <- svyglm(omsysval ~ Age +Sex + EnergykJ_4 , ndns_1_11e)
...
sensemakr(lm4b, treatment = "EnergykJ_4")
...
```{r echo=FALSE}
lm4c <- svyglm(omsysval ~ Age +Sex +Sodiummg  , ndns_1_11e)
...
lmallg <- svyglm(omsysval~ Age+ Sex + Sodiummg +pcnt_4, ndns_1_11e)
lmallg
anova(lmallg)
...
```{r message=FALSE, warning=FALSE, include=FALSE}
lmallE <- svyglm(omsysval~ Age+ Sex + Sodiummg +Epcnt_4, ndns_1_11e)
lmallE
anova(lmallE)
AIC(lmallE)
