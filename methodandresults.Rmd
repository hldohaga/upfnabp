...
```{r keydata, echo=FALSE, message=FALSE, warning=FALSE, caption = "The key data"}
...
```{r upf and survey year, echo=FALSE, message=FALSE, warning=FALSE,fig.cap = "Survey Year"}
...
```{r Na and survey year, echo=FALSE, message=FALSE, warning=FALSE,fig.cap = "Na Survey Year"}
...
```{r BP and survey year, echo=FALSE, message=FALSE, warning=FALSE,fig.cap = "BP Survey Year"}
...
```{r  BP Sex Boxplots, echo=FALSE, message=FALSE, warning=FALSE,fig.cap = "BP sex"}


svyboxplot(omsysval~Sex,ndns_1_11ed, na.rm = TRUE,main = "Systolic BP in mmHg by Sex", ylab = "Sysltolic BP in mmHg" ,xlab ="Sex")
```

```{r Na Sex Boxplots, echo=FALSE, fig.cap=, message=FALSE, warning=FALSE, fig.cap= "Na Sex Boxplot"}

svyboxplot(Sodiummg~Sex,ndns_1_11ed, na.rm = TRUE,main = "Sodium Intake in mg by Sex", ylab = "Sodium intake in mg" ,xlab ="Sex")
```

```{r UPF Sex Boxplots, echo=FALSE, message=FALSE, warning=FALSE,fig.cap = "UPF sex"}
...
```{r univariable regressions, echo=FALSE, message=FALSE, warning=FALSE, tab.cap= "Univariable Regressions"}
