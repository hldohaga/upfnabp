...
And see Table \@ref(tab: keydata)
```{r keydata, echo=FALSE, message=FALSE, warning=FALSE,tab.id=TRUE, tab.cap = "The key data",out.width=80%}

#summary(ndns_1_11d$variables$omsysval)
...
```{r Na and survey year, echo=FALSE, message=FALSE, warning=FALSE,fig.id=TRUE,fig.cap = "Na Survey Year"}
