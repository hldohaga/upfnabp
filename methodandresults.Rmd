...
```{r keydata, echo=FALSE, message=FALSE, warning=FALSE,tab.id=TRUE, tab.cap = "The key data"}
...
```{r Key Variables  by Survey year, echo=FALSE, caption="Key Variables"}
...
```{r continuous data, echo=FALSE, message=FALSE, warning=FALSE, caption = "Continuous Variables by survey year"}
...
```{r Categorical variables against Survey Year, echo=FALSE, message=FALSE, warning=FALSE, caption= "Categorical variables against Survey Year"}
...
```{r multivariable outputs, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r AIC comparison, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r AIC sense, echo=FALSE, message=FALSE, warning=FALSE}
