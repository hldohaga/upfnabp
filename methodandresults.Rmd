...
keydatw <-tbl_svysummary(ndns_1_11d,SurveyYear , include = c(Sodiummg,Epcnt_4,pcnt_4,omsysval),
...
tbl_merge(list(ttestNa2t,ttestEpcntt),tab_spanner = c("Sodium in mg", "Percent Energy UPF"))
...
sexchi <- svychisq(~SurveyYear+Sex , ndns_1_11d)
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
tableedu <- svytable(~educfinh+(SurveyYear), ndns_1_11d)
#tableedu
...
```{r echo=FALSE}
tableimd <- svytable(~EIMD_2010_quintile +SurveyYear , ndns_1_11d)
#tableimd
...
add_global_p( tbl_regression(lm1AS))
