...
```{r Na-age-Boxplots, echo=FALS,message=FALSE, warning=FALSE}
...
The study is extremely well constructed. However it was not designed to gather information about UPF and so analysis of this is compromised. The classification of foods as UPF is done based on standard descriptions and if it had been done contemporaneously foods may have been entered into different categories.



### The data

The data is accurate as presented. Weighting is made for non uptake and dropping out of the study in each year and is associated with some reduced statistical power. However the robustness of the data and the care in sampling and preliminary analysis have optimised the opportunities for good results.


### The analysis

The approach largely uses general linear model regression on weighted data sets. This reduces the statistical power slightly. This does not seem to have altered the results from unweighted models.
