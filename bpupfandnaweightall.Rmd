...
#categorical data
stable11 <- xtabs(~ndns_1_11[SurveyYear >= 9,Sex*wti_UKY1to11])
stable4 <- xtabs(~ ndns_1_11[SurveyYear <= 4,Sex*wti_UKY1to11])
...
plot(ndns_1_11[SurveyYear >= 9,Sex*wti_UKY1to11], main = "2019", caption = "Bar Plot of Sex in 2019 cohort")
plot( ndns_1_11[SurveyYear <= 4,Sex*wti_UKY1to11], main = "2010",caption = "Bar Plot of Sex in 2019 cohort")
boxplot(ndns_1_11[,Sex*wti_UKY1to11], ndns_1_11[,SurveyYear])
...
ttestht <- t.test(ndns_1_11[SurveyYear >= 9,htval2*wti_UKY1to11], ndns_1_11[SurveyYear <= 4,htval2*wti_UKY1to11])
ttestwt <- t.test(ndns_1_11[SurveyYear >= 9,wtval2*wti_UKY1to11], ndns_1_11[SurveyYear <= 4,wtval2*wti_UKY1to11])
ttestbmi <- t.test(ndns_1_11[SurveyYear >= 9,bmival2*wti_UKY1to11], ndns_1_11[SurveyYear <= 4,bmival2*wti_UKY1to11])
...
#saltset
vtable11 <- xtabs(~ndns_1_11[SurveyYear >= 9,vegetarn*wti_UKY1to11])
vtable4 <- xtabs(~ ndns_1_11[SurveyYear <= 4,vegetarn*wti_UKY1to11])
...
lm1g <- lm((omsysval*wti_UKY1to11) ~ (pcnt_4*wti_UKY1to11), ndns_1_11)
