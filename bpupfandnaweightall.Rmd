...
ndns_1_11 <-as.data.table(read_sav(sav4b))
...
ethnset <- c("seriali" ,"ethgrp5","ethgrp2")
saltset <- c("seriali","SaltChk","SalHowC","SltSHow" ,"vegetarn")
medsset <- c("seriali", "bpmedc2","bpmedd2","diur2","beta2","aceinh2", "calciumb2","obpdrug2", "PregNowB")
hypset <- c("seriali", "hyper140_2", "hibp140_2", "hyper1_2", "highbp1_2")
incset <-c("seriali","nssec8","gor","region", "EIMD_2007_quintile","EIMD_2010_quintile","EIMD_2015_quintile","educfinh")
measset <- c("seriali","htval","wtval","bmival")
ageset <- c("seriali","agegad1", "agegad2", "agegch1","agegr1","age")
weightset <- c("seriali","wti_UKY1to11","astrata1","area")
...
dw <- svydesign(ids = ~area, weights = ~ wti_UKY1to11, strata=~astrata1, data = ndns_1_11)
```
