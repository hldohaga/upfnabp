...
sensemakr(lm1g, treatment = "sqrt(pcnt_4)")
...
#linear regression models
#UPF Energy % only
lm1E <- lm(omsysval ~ Epcnt_4, ndns_1_11)
...
#linear regression models
#sodium only
lm1na <- lm(omsysval ~ Sodiummg, ndns_1_11)
...
#linear regression models
#sodium only
lm1AS <- lm(omsysval ~ Age + Sex, ndns_1_11)
...
```{r echo=FALSE}
lmM <- lm(omsysval ~ Age +Sex +Sodiummg + sqrt(pcnt_4)+ ethgr2 + VitaminDµg + EducFin+ EIMD_2010_quintile , ndns_1_11,na.action = na.exclude)
...
```{r echo=FALSE}
lmM2 <- lm(omsysval ~ Age +Sex +Sodiummg + Epcnt_4+ ethgr2 + VitaminDµg +EducFin+ EIMD_2010_quintile , ndns_1_11,na.action = na.exclude)
...
```{r echo=FALSE}
lmMna <- lm(omsysval ~ Age +Sex +Sodiummg + sqrt(pcnt_4) , ndns_1_11,na.action =na.exclude)
...
```{r echo=FALSE}
lmMnaE <- lm(omsysval ~ Age +Sex +Sodiummg + Epcnt_4 , ndns_1_11,na.action =na.exclude)
...
```{r echo=FALSE}
lmMg <- lm(omsysval ~ Age +Sex + sqrt(pcnt_4) , ndns_1_11)
...
```{r echo=FALSE}
lm4b <- lm(omsysval ~ Age +Sex + Epcnt_4 , ndns_1_11)
...
```{r echo=FALSE}
lm4c <- lm(omsysval ~ Age +Sex +Sodiummg  , ndns_1_11)
