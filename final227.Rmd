...
Sodium intake was included in their table 1 but they made no comment on how it might relate to hypertension or UPF consumption.
...
The north has 46% of those with high Sodium intake, much the highest.
...
#univariables <- as_flex_table(tbl_stack(list(lm1nat,lmEnat,lm1Et,lmEAt,lmAt,lmNaAt,lm1bmit,lm1Ag1t,lmedt,lmEbmit,lmEst,lmEedt,lmNabmt,lmNaAgt,lmNaedt),group_header = c("BP/Sodium","UPF/Sodium","UPF/bp","UPF/Age","Age/BP","Age/Sodium","BP/bmi","BP/Agg1","BP/ed","UPF/bmi","UPF/age","UPF/ed","Sodium/bmi","Sodium/Agg","Sodium/ed")))
...
The 'best' of these models is that with only Sodium included "Sodium only".
