...
```{r upf-and-survey-year, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r BP-and-survey-year, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Key-Variables-by-Sex, echo=FALSE}
...
```{r Na-age-Boxplots, echo=FALSE,message=FALSE, warning=FALSE}
...
```{r UPF-age-Boxplots, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r Key-Variables-by-age, echo=FALSE}
...
```{r Categorical-variables-year, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r BP-and-UPF,echo=FALSE, message=FALSE, warning=FALSE}
...
```{r UPF-and-Na-plot,echo=FALSE,  message=FALSE, warning=FALSE}
...
```{r univariable-regressions, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r more-univariable-regressions, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r na-multivariable-outputs, echo=FALSE, message=FALSE, warning=FALSE}
