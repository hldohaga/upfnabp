...
catconfounders3b <- data.table("name" = c("ethgrp5","ethgrp2","nssec8"),"p.value" =signif(c(e5tabler$p.value, e2tabler$p.value, n8tabler$p.value),digits = 4))
...
catconfounders4a <- data.table("name" = c("agegad1","agegad2","agegch1","agegr1"),"p.value" = signif( c( ad1tabler$p.value , ad2tabler$p.value, ch1tabler$p.value, ag1tabler$p.value), digits = 4))
