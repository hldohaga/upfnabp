...
```{r echo=FALSE}
lm4 <- lm(omsysval ~ Age +Sex +Sodiummg + TotalEMJ + ethgr2 + VitaminDµg + EIMD_2010_quintile , sav4rp)

#plot(lm1)

lm11 <- lm(omsysval ~ AgeR +Sex +Sodiummg + TotalEMJ +ethgrp2 +VitaminDµg + EIMD_2010_quintile, sav11rp)
lm4
lm11
#plot(lm1m)
#lm1a$coefficients
