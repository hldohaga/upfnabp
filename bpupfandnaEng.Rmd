...
bpEMJ <-data.table("2010" =c(sav4rp[,pcnt_4]),"2019" = c(sav11rp[,pcnt_4]))
boxplot(bpEMJ, main = "Percent UPF 2010 vs 2019", xlab = "year", ylab = "pcnt_4")
...
#linear regression models
#sodium only
lm1E4 <- lm(omsysval ~ pcnt_4, sav4rp)


lm1E11 <- lm(omsysval ~ pcnt_4, sav11rp)
lm1E4
lm1E11
...
```{r echo=FALSE}
lm4 <- lm(omsysval ~ Age +Sex +Sodiummg + pcnt_4 + ethgr2 + VitaminDµg + EIMD_2010_quintile , sav4rp)

#plot(lm1)

lm11 <- lm(omsysval ~ AgeR +Sex +Sodiummg + pcnt_4 +ethgrp2 +VitaminDµg + EIMD_2010_quintile, sav11rp)
lm4
lm11
#plot(lm1m)
#lm1a$coefficients
