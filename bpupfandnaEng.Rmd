...
```{r echo=FALSE}
lm4 <- lm(omsysval ~ Age +Sex +Sodiummg + Epcnt_4+ ethgr2 + VitaminDµg + EIMD_2010_quintile , sav4rp,na.action = na.exclude)

#plot(lm1)

lm11 <- lm(omsysval ~ AgeR +Sex +Sodiummg + Epcnt_4 +ethgrp2 +VitaminDµg + EIMD_2010_quintile, sav11rp,na.action = na.exclude)
lm4
lm11
#plot(lm1m)
#lm1a$coefficients
...
sensemakr(lmallE, treatment = "Epcnt_4")
sensemakr(lmallg, treatment = "pcnt_4")
