...
The review objective is to contribute to answering the research question;
...
They were searched through Scopus and Medline(ovid)
...
grViz(diagram = "digraph flowchart {
  ...
  [3]: 'reading titles and abstracts 87'    
  ")
```

Search 2 gave 211 papers.
The lists of details from each search were downloaded.
Then the two lists were added together using RefmanageR @matt .
...
This eliminated 303 papers.

## discussion of results

The literature has developed over time.
In Dahl's paper @dahl1968 from 1968 the 'artificial' nature of food for infants is discussed.
