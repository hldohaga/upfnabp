...
It is a pragmatic response to manipulating the strange food economy described by Dimblebey @dimbleby. Armendariz @armendariz2022 looks at how the retail food environment in Mexican cities has changed and how it affects BP.
...
This table @tbl-table1 shows all variables.
...
## Discussion of change across waves
...
#### of other variables compared across waves
