...
keydatw1 <-tbl_svysummary(ndns_1_11d, include= c(Age, agegad3, omsysval,hyp, bmival, Na,hiNa, UPF,UPF3, educfinh, IMD,gor,bpd ))
#keydatw1
keydatwdd <-tbl_svysummary(ndns_1_11dd, include= c(Age, agegad3, omsysval,hyp, bmival, Na,hiNa, UPF,UPF3, educfinh, IMD,gor,bpd ) )

keydatwdf <-tbl_svysummary(ndns_1_11f, include= c(Age, agegad3, omsysval,hyp, bmival, Na,hiNa, UPF,UPF3, educfinh, IMD,gor,bpd ) )
keydatwT <- tbl_merge(list(keydatw1,keydatwdd,keydatwdf),tab_spanner = c("Whole Population", "Population with those on BP medication excluded","Female"))
