...
#earlyrp <- rbind(sav4rp,sav6rp)
#earlyrp#<- rbind(earlyrp,sav8rp)
...
bpset4 <- sav4br[,c("seriali","omsysval","omdiaval")]
...
```{r 4setup variables, message=FALSE, warning=FALSE, include=FALSE}
 #measured and recorded data yr1-4a_indiv_uk 
#subsets of the table to identify grouped information
bpset6 <- sav6br[,c("seriali","omsysval","omdiaval")]
...
```{r 4setup variables, message=FALSE, warning=FALSE, include=FALSE}
 #measured and recorded data yr1-4a_indiv_uk 
#subsets of the table to identify grouped information
bpset8 <- sav8br[,c("seriali","omsysval","omdiaval")]
#ethnset6 <- sav6br[,c("seriali","ethgr2")]
...
bpsetall <- data.table(rbind(bpset4,bpset6))
bpsetall <- data.table(rbind(bpsetall,bpset8))
bpsetall <- data.table(rbind(bpsetall,bpset11))
