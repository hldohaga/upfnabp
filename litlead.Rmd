...
table1 <- data.table("Abbreviation "=c("NDNS","BP","Na","UPF","NCD","CVD","CHAMPs","NOVA","NAFLD","BMI","AIC"),"Term"=c("National Dietary and Nutrition Survey","Blood Pressure","Sodium intake in mg", "Ultra Processed Foods", "Non communicable Disease","Cardiovascular Disease","Cheshire and Merseyside public health  collaborative","NOVA is a classification system, it is not an acronym","non- alcohol fatty liver disease","Body Mass Index","Akaike Information Criterion"))
...
Scopus @scopus2 , Pubmed and Medline(ovid) @ovid:se were searched.
...
search1 <- data.table("Name"=c("Date of Search","Number of results" ),
                      "Scopus search"=c("17/6/23","1774"),
                      "Medline(Ovid)Search" =c("17/6/23","1821"),"Pubmed search"=c("17/6/23","482"),"Total"=c("17/6/23","4077"))
                                                                                                                                                        
table2 <-flextable(search1)
table2 <- add_header_lines(table2, values = c("search terms ((\"ultraprocessed food*\" OR \"ultra-processed food*\" OR \"ultra processed food*\" OR \"NOVA food*\")OR (salt OR sodium)) AND ( \"blood pressure\" OR hypertension OR \"cardiovascular disease\" OR \"cardiovascular risk\")AND(cohort OR cross-section* OR prospective)", "Inclusion prospective and observational studies and systematic reviews on hypertension","Exclusions include tightly specified populations, disease groups or outputs"))
...
Search 1 produced 6 results, 5 articles, 1 review.
Search 2 35 papers, search 3 2 papers, and search 4 11.
...
grViz(diagram = "digraph flowchart {
  ...
  [1]: 'Initial searches 4077 (1774,1821 and 482)  papers'
  [2]: 'adjusting for overlap 1979'    
  [3]: 'comparing with exclusion criteria 11'  
  [4]: 'upf and hypertension 7' 
  [5]: 'Meta-analysis and salt and CVD 4' 
  ")
```

The references from each search were examined for duplicates.
Once these were eliminated the total of unique papers was 1979.
These were then reviewed by comparing the titles against the inclusion and exclusion criteria leaving 63.
Articles which were not cross sectional studies, or had specific populations such as women in pregnancy were excluded.

There were14 remaining.
Additional relevant studies have also been identified by my supervisors and from bibliographies of identified articles.
...
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| First Author                                        | Type                                                      | subject              | Results |
+=====================================================+===========================================================+======================+=========+
| shim @ShimSunYoung2022Couf                          | crossection                                               | UPF and Hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| scaranni @ScaranniPatriciadeOliveiradaSilva2021Ufci | cohort                                                    | UPF and Hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| Zhang @zhang2021                                    | cross section                                             | UPF and 'CVH'        |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| rezendez-alves @rezende-alves2021                   | cohort                                                    | UPF and Hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| barbosa @barbosa2023                                | systematic review                                         | UPF and Hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| monge                                               | cohort                                                    |                      |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| harrington @Harrington20131311                      |                                                           |                      |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| wang @wangAssociationUltraprocessedFood2022         | systematic review and meta analysis                       | UPF and hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| asma @Asma201949                                    |                                                           |                      |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| d'avila @davila2017                                 |                                                           |                      |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| de Deus Mendonca @DeDeusMendonçaRaquel2017Ufca      | cohort                                                    | UPF and hypertension |         |
|                                                     |                                                           |                      |         |
| middle aged uni grads                               | adjusted HR, 1.21; 95% CI, 1.06, 1.37; P for trend = 0.00 |                      |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| ming @mingli                                        | cohort                                                    | UPF and hypertension |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| mambrini @mambrini2023                              | systematic review                                         | upf and CVD          |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| Strazzullo @strazzullo2009                          | meta-analysis                                             | Salt and CVD         |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| D'Elia @delia2018                                   | meta-analysis                                             | Salt and CVD         |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
| Graudal @graudal2014                                | meta-analysis                                             | Salt and CVD         |         |
+-----------------------------------------------------+-----------------------------------------------------------+----------------------+---------+
...
Zhang et al. have demonstrated a reverse gradient between UPF intake and CVH\* using the USA NHANES cvh seems to be BMI and diabetes, cholesterol has an opposing affect, and BP seems to zeroed

Wang provided a systematic review and meta analysis
...
The papers on salt and BP show that salt increases the risk of all
cause mortality, and cardiovascular disease endpoints, the literature
does not identify hypertension.

\
D\'Elia et al look at arterial stiffness pressure wave velocity \'PWV\' and show that
this increases with salt intake.
This arterial stiffness is
potentially more sensitive to sodium intake than BP.


\"*Eleven studies
met the predefined inclusion criteria and provided 14 cohorts with
...
was associated with a 2.84% (95% CI0.51--5.08) reduction in PWV.\"*
...
\"*Data from 23
cohort studies and 2 follow-up studies of RCTs (n = 274,683) showed
...
the papers on UPF
and Hypertension show an increase in hypertension with increased upf
intake

\

two meta analyses
that of Wang et al and mambrini et al highlight the risk of
hypertension with high UPF

\

## Literature review Conclusion

Of the cross-sectional studies looking at hypertension, sodium and UPF the majority describe 2/3 elements, often around diet and salt intake.
These studies are often limited to examining specific groups eg pregnant women.

The core relevant studies show an odds ratio for hypertension with raised SODIUM INTAKE
...
univariables<- set_caption(univariables, "Univariable Regression NDNS data 2008-2019", autonum = run_autonum(seq_id = "tab", bkm = "tab8"))
univariables
