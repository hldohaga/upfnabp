...
+-----------------------------------------------------+-----------------+---------------------------------------+-----------------------------------------------------------+
| Ming @ming                                          | cohort          | UPF and hypertension                  |                                                           |
+-----------------------------------------------------+-----------------+---------------------------------------+-----------------------------------------------------------+
...
tablecat<- data.table("Variable"=c( "Sex", "IMD","Age","BMI","Region"),"ChiSq"=c(sexchi$statistic,imdchi$statistic,agegad3chi$statistic,BMIchi$statistic,gorchi$statistic ),"p.value"= c(sexchi$p.value,imdchi$p.value,agegad3chi$p.value,BMIchi$p.value,gorchi$p.value ))
