...
table1 <- data.table("Abbreviation "=c("NDNS","BP","Na","UPF","NCD","CVD","CHAMPs","NOVA","IMD","BMI","OR","HR", "CI","AIC"),"Term"=c("National Dietary and Nutrition Survey","Blood Pressure","Sodium intake in mg", "Ultra Processed Foods", "Non communicable Disease","Cardiovascular Disease","Cheshire and Merseyside public health  collaborative","NOVA is a classification system, it is not an acronym","Index of Multiple Deprivation","Body Mass Index","Odds Ratio", "Hazard ratio","Confidence intervals 95% level","Akaike Information Criterion"))
...
Wang's meta analysis included six more studies; Ivancovsky-Wajcman OR = 1.53, (1.07- 2.19), Levigne-Robichaud OR =0·99 (0·59, 1·68), Martinez-Steele OR =1.19 (1.03,1.38), Nardocci OR = 1.60, (1.26--2.03), Nasreddine OR =3.10, (0.84,16.66), Rezende-Alves OR =1.35 (1.01,1.81).
...
He Identifies the inclusion of papers with big effect sizes, and short follow up in Graudal as contributing to their identification of an effect of very low sodium intakes.
...
This is why the overall sample size needs to be so large.
This is why a national study is useful.
...
There is a slight reduction in UPF % over the waves, this variability might be reporting, or assessment.
There were some changes to understanding and analysis.
...
It showed some significant differences between measured energy intake, and reported energy intake with differences between different age groups.
...
Wang @wangAssociationUltraprocessedFood2022 , Barbosa @barbosa2022 , and Mambrini @mambrini2023 all find a positive correlation using longitudinal studies @ScaranniPatriciadeOliveiradaSilva2021Ufci @mendoncaUltraProcessedFoodConsumption2017 .
...
This finding suggests that the effect of each variable is not the whole effect, that there is a synergistic effect.
This would fit with the idea that Monteiro's concept of UPF @monteiro2010 is wider than being simply a nutritional effect.
This might be due to broader biologic effects (eg structural, or energy density @rauber2020 ), or could relate to the wider economic and cultural aspects of UPF.

Mertens @mertens2022 and niMurchu @nimhurchu2011 identify that the UK has one of the highest % intake of UPF.
Reducing intake might be the behaviour of a saturated market.
The USA or Canada might behave similarly.
Other European countries are still fighting to retain a different food culture @srour2019 @touvier2020 .
Countries in the rest of the world are at differing levels of transition @ColombetZoé2021Dass .
...
These include measured variables such as BMI, biochemical indicators (eg Hba1c) and medical diagnostic categories(eg Diabetes).
...
These complex models can be used in evaluating policy effects.
...
Ideas include legislation to reduce UPF use, this might be by pricing, greater care in licencing ingredients, or developing a broader food policy .
